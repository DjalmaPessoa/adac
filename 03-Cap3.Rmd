...
desde que $\pi _{ij} > 0 \quad \forall i,j \in U$, como suposto neste livro (Seção \ref{Planamo}).
...
## Linearização de Taylor para Estimar variâncias \label{taylor}
...
de totais, pode ser aplicado também para estimar (por linearizaç%
ão) quantidades populacionais que possam ser representadas como funç%
ões de totais, conforme discutido na Seção \ref{taylor}. De
