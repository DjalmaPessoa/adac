...
de qualidade global de ajuste, na primeira linha da Tabela \ref
...
Nas Secões \@ref(modlinear) e \@ref(modlogist) discutimos formas de introduzir pesos e plano
...
detalhes nos Capítulos \@ref(testequalajust) e \@ref(testeta2) para o caso da análise de dados
categóricos.
