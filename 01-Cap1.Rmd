...
source("~\\GitHub\\adac\\data\\ppv1.R")
library(survey)
# transforma nomes de variáveis para minúsculas
...
Esse assunto será tratado em detalhes no Capítulo \@ref(epa) . Por enquanto, apresentaremos uma 
introdução necessária para compreender os valores na Tabela \ref{table:Tab13}.

O efeito de plano amostral (EPA) de Kish é definido na fórmula 
\@ref(eq:epa1), na página 54 do livro. Vamos considerar o caso particular em que $\hat{\theta}$ é um estimador de total de uma variável $Y$.Ou seja
\[
