...
Os Capítulos \@ref(testqualajust) e  \@ref(testtab2) tratam da análise de dados
...
O Capítulo \@ref(agregacao-vs-desagregacao) discute algumas formas alternativas de analisar dados de
...
O efeito de plano amostral (EPA) de Kish é definido na fórmula 4.1, na página 54 do livro. Vamos considerar o caso particular em que $\hat{\theta}$ é um estimador de total de uma variável $Y$.Ou seja
\[
