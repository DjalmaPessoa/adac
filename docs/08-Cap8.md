...
Table: (\#tab:frqamost)Frequências Amostrais por celas na PNADRJ90
...
Table: (\#tab:proplinha)Proporções nas linha, desvios padrões e EPAs de re para cada nivel de sx
...
Table: (\#tab:unnamed-chunk-1)Proporções nas linha, desvios padrões e EPAs de `re` na população
...
Table: (\#tab:propcelas)Proporções nas cela, desvios padrões e EPAs
...
Table: (\#tab:unnamed-chunk-3)Proporções nas linha, desvios padrões e EPAs de sx na população
