...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-1"><strong>(\#ex:unnamed-chunk-1)</strong></span>Correções de EPA médio das estatísticas $X_{P}^{2}\left(I\right)$ e $X_{P}^{2}\left(H\right)$.</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-4"><strong>(\#ex:unnamed-chunk-4)</strong></span>Estimativas de medidas descritivas em tabelas</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-13"><strong>(\#ex:unnamed-chunk-13)</strong></span>Testes de Hipóteses</div>\EndKnitrBlock{example}
