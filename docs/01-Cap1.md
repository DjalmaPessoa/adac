...
Table: (\#tab:unnamed-chunk-46)Proporção de diagnóstico de depressão por sexo
...
Table: (\#tab:unnamed-chunk-47)Proporção de diagnóstico de depressão por situação
...
Table: (\#tab:unnamed-chunk-49)Proporção de diagnóstico de depressão por uf
...
Table: (\#tab:unnamed-chunk-55)Proporção de pessoas com seguro de saúde por nível de instrução
...
<img src="01-Cap1_files/figure-html/unnamed-chunk-56-1.png" width="672" />
