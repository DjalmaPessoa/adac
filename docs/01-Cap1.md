...
Table: (\#tab:unnamed-chunk-11)Proporção de analfabetos para faixas etárias 7-14 anos e mais de 14 anos
...
Table: (\#tab:unnamed-chunk-41)Proporção de diagnóstico de depressão por sexo
...
Table: (\#tab:unnamed-chunk-42)Proporção de diagnóstico de depressão por situação
...
Table: (\#tab:unnamed-chunk-44)Proporção de diagnóstico de depressão por uf
...
Table: (\#tab:unnamed-chunk-50)Proporção de pessoas com seguro de saúde por nível de instrução
...
<img src="01-Cap1_files/figure-html/unnamed-chunk-51-1.png" width="672" />
