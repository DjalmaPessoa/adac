...
\caption{(\#tab:unnamed-chunk-52)Proporção de diagnóstico de depressão por situação}
\centering
\begin{tabular}[t]{lrrr}
\toprule
...
\caption{(\#tab:unnamed-chunk-54)Proporção de diagnóstico de depressão por uf}
\centering
\begin{tabular}[t]{lrrr}
\toprule
uf & prop & l.i.c. & l.s.c\\
...
![](01-Cap1_files/figure-latex/unnamed-chunk-60-1.pdf)<!-- --> 
