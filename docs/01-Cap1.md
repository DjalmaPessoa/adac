...
\caption{(\#tab:unnamed-chunk-47)Proporção de diagnóstico de depressão por sexo}
\centering
...
Table: (\#tab:unnamed-chunk-48)Proporção de diagnóstico de depressão por situação
...
Table: (\#tab:unnamed-chunk-50)Proporção de diagnóstico de depressão por uf
...
\caption{(\#tab:unnamed-chunk-56)Proporção de pessoas com seguro de saúde por nível 
de instrução}
\centering
\begin{tabular}[t]{rrr}
\toprule
...
<img src="01-Cap1_files/figure-html/unnamed-chunk-57-1.png" width="672" />
