...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-2"><strong>(\#def:unnamed-chunk-2)</strong></span>O efeito da especificação incorreta do plano amostral (ou do modelo)
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-6"><strong>(\#ex:unnamed-chunk-6)</strong></span>\label{exebin}Teste de hipótese sobre proporção</div>\EndKnitrBlock{example}
