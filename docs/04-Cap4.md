...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-1"><strong>(\#def:unnamed-chunk-1)</strong></span>O **Efeito do Plano Amostral ($EPA$)**  **de Kish** para um estimador $\hat{\theta}$ é</div>\EndKnitrBlock{definition}
\begin{equation}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:epakish"><strong>(\#ex:epakish)</strong></span>Efeitos de plano amostral de Kish para estimadores de totais
...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:unnamed-chunk-2"><strong>(\#def:unnamed-chunk-2)</strong></span>O efeito da especificação incorreta do plano amostral (ou do modelo) sobre a estimativa $v_{0}$ da variância do estimador $\hat{\theta}$ é </div>\EndKnitrBlock{definition}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:deffuni"><strong>(\#ex:deffuni)</strong></span>Efeitos de plano amostral para estimação de
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-5"><strong>(\#ex:unnamed-chunk-5)</strong></span>População conglomerada com conglomerados de tamanho 2 
...
<div class="figure">
<img src="Figuras/fig41.png" alt="Valores de EPA e EPA de Kish para conglomeração"  />
<p class="caption">(\#fig:epacong)Valores de EPA e EPA de Kish para conglomeração</p>
</div>
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:exebin"><strong>(\#ex:exebin)</strong></span>Teste de hipótese sobre proporção</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:deffmult"><strong>(\#ex:deffmult)</strong></span>Efeitos Multivariados do Plano Amostral para as médias
