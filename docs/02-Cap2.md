...
![(\#fig:modclas)Modelagem Clássica](Figuras/fig21.png) 
...
![(\#fig:modamo)Amostragem Probabilística](Figuras/fig22.png) 
...
![(\#fig:modsup)Modelagem de Superpopulação](Figuras/fig23.png) 
