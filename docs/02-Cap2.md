...
\begin{figure}
\includegraphics[width=10.6in]{Figuras/Figura2.1} \caption{Modelagem Clássica}(\#fig:modclas)
\end{figure}
...
\begin{figure}
\includegraphics[width=13.89in]{Figuras/fig22} \caption{Amostragem Probabilística}(\#fig:modamo)
\end{figure}
...
\begin{figure}
\includegraphics[width=13in]{Figuras/fig23} \caption{Modelagem de Superpopulação}(\#fig:modsup)
\end{figure}
