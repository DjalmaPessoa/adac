...
dessa abordagem é apresentada no Tabela  \@ref(tab:Tab22), e uma representação gráfica resumida na Figura \@ref(fig:modamo).
...
apresentada no Tabela  \@ref(tab:Tab23).
