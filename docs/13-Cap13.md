...
Table: (\#tab:iid)Análise do modelo (9.16) sob hipótese de observações IID, ignorando complexidades do plano amostral
...
Table: (\#tab:logist)Análise agregada do modelo (9.16), usando MPV e
...
Table: (\#tab:wald)Análise agregada do modelo (9.16), usando estatísticas
...
Table: (\#tab:ml3)Análise desagregada do modelo (9.18) via programa (ML3)
...
Table: (\#tab:mod2)Efeitos da escola na eficácia do professor (Modelo II)
...
Table: (\#tab:mod3)Efeitos da escola na eficácia do professor (Modelo III)
...
Table: (\#tab:mod4)Efeitos da escola na eficácia do professor (Modelo IV)
