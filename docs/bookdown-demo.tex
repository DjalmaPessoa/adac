...
\NormalTok{)}
\NormalTok{knitr::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{as.data.frame}\NormalTok{(res), }\DataTypeTok{booktabs =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{format =} \StringTok{"latex"}\NormalTok{, }
...
\BeginKnitrBlock{remark}
\iffalse {Observação } \fi No data frame pes\_sel o nome das variáveis,
...
\BeginKnitrBlock{example}
\protect\hypertarget{ex:unnamed-chunk-146}{}{\label{ex:unnamed-chunk-146}}Plano
...
\BeginKnitrBlock{example}
\protect\hypertarget{ex:unnamed-chunk-147}{}{\label{ex:unnamed-chunk-147}}(\citep{bryk},
Cap. 5)
\EndKnitrBlock{example}
