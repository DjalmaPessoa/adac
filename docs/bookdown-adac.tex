...
\caption{\label{tab:unnamed-chunk-47}Proporção de diagnóstico de depressão por sexo}
\centering
...
\caption{\label{tab:unnamed-chunk-48}Proporção de diagnóstico de depressão por situação}
\centering
\begin{tabular}[t]{lrrr}
\toprule
...
\caption{\label{tab:unnamed-chunk-50}Proporção de diagnóstico de depressão por uf}
\centering
\begin{tabular}[t]{lrrr}
\toprule
uf & prop & l.i.c. & l.s.c\\
...
Considerando os dados do Exemplo \ref{exm:pnad} do Capítulo
...
\ref{exm:pnad} do Capítulo \ref{modreg}.
...
\toprule
sx & re1 & re2 & re3 & se.re1 & se.re2 & se.re3 & DEff.re1 & DEff.re2 & DEff.re3\\
\midrule
1 & 0.111 & 0.591 & 0.298 & 57.269 & 102.576 & 111.213 & 1.422 & 1.863 & 2.531\\
2 & 0.240 & 0.570 & 0.190 & 125.026 & 119.375 & 111.410 & 1.911 & 1.298 & 1.802\\
\bottomrule
\end{tabular}
\end{table}
...
estimativa na cela (1,1) da \ref{tab:proplinha}, apresentado na cela
(1,7) dessa tabela.
...
\toprule
  & mean & SE & deff\\
\midrule
sx=1,re=1 & 0.073 & 38.343 & 1.416\\
sx=2,re=1 & 0.082 & 44.401 & 1.698\\
sx=1,re=2 & 0.388 & 80.435 & 1.775\\
sx=2,re=2 & 0.195 & 51.582 & 1.103\\
sx=1,re=3 & 0.196 & 71.772 & 2.131\\
sx=2,re=3 & 0.065 & 40.219 & 1.731\\
\bottomrule
\end{tabular}
\end{table}
...
##   \hline
## 1 & 0.11 & 0.59 & 0.30 & 0.01 & 0.01 & 0.01 \\ 
##   2 & 0.24 & 0.57 & 0.19 & 0.01 & 0.01 & 0.01 \\ 
##    \hline
## \end{tabular}
## \caption{Proporções por sexo} 
## \end{table}
\end{verbatim}
