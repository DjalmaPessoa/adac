...
\NormalTok{ppv.dat <-}\StringTok{ }\NormalTok{ppv}
\KeywordTok{dim}\NormalTok{(ppv.dat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{names}\NormalTok{(ppv.dat)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ppv1.dat <-}\StringTok{ }\KeywordTok{transform}\NormalTok{(ppv.dat, }
...
\texttt{pesof}. O objeto de desenho amostral, \texttt{ppv.plan}
...
\NormalTok{ppv.plan<-}\KeywordTok{svydesign}\NormalTok{(}\DataTypeTok{ids =} \OperatorTok{~}\NormalTok{nsetor, }\DataTypeTok{strata =} \OperatorTok{~}\NormalTok{estratof,}
\DataTypeTok{data =}\NormalTok{ ppv1.dat, }\DataTypeTok{nest =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{weights =} \OperatorTok{~}\NormalTok{pesof)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ppv.se.plan <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(ppv.plan, regiao }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svytotal}\NormalTok{(}\OperatorTok{~}\NormalTok{analf1, ppv.se.plan, }\DataTypeTok{deff =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svytotal}\NormalTok{(}\OperatorTok{~}\NormalTok{analf2, ppv.se.plan, }\DataTypeTok{deff =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svyratio}\NormalTok{(}\OperatorTok{~}\NormalTok{analf1, }\OperatorTok{~}\NormalTok{faixa1, ppv.se.plan)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Ratio estimator: svyratio.survey.design2(~analf1, ~faixa1, ppv.se.plan)
## Ratios=
##          faixa1
## analf1 0.118689
## SEs=
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svyratio}\NormalTok{(}\OperatorTok{~}\NormalTok{analf2, }\OperatorTok{~}\NormalTok{faixa2, ppv.se.plan)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Ratio estimator: svyratio.survey.design2(~analf2, ~faixa2, ppv.se.plan)
## Ratios=
##           faixa2
## analf2 0.1086871
## SEs=
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svyby}\NormalTok{(}\OperatorTok{~}\NormalTok{analf1, }\OperatorTok{~}\NormalTok{regiao, ppv.plan, svytotal, }\DataTypeTok{deff =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ppv.plan <-}\StringTok{ }\NormalTok{ppv.dat }\OperatorTok{%>%}\StringTok{ }\KeywordTok{as_survey_design}\NormalTok{ (}\DataTypeTok{ids =}\NormalTok{ nsetor, }\DataTypeTok{strata =}\NormalTok{ estratof,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ppv.plan <-}\StringTok{ }\NormalTok{ppv.plan }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res <-}\StringTok{ }\NormalTok{ppv.plan }\OperatorTok{%>%}\StringTok{  }
...
microdados e salvá-los em um data frame \texttt{pnadc032016.dat}.
...
\NormalTok{pnadc032016.dat <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{( }\KeywordTok{paste0}\NormalTok{( }\KeywordTok{tempdir}\NormalTok{() , }\StringTok{"/pnadc 2016 03.rds"}\NormalTok{ ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{saveRDS}\NormalTok{(pnadc032016.dat, }\DataTypeTok{file=}\StringTok{"C:/adac/pnadc/pnadc 2016 03.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Partindo do arquivo \texttt{pnadc\ 2016\ 03.rds}, podemos recuperar o
data frame \texttt{pnadc032016.dat}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pnadc032016.dat <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"C:/adac/pnadc/pnadc 2016 03.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pnadc032016.plan <-}\StringTok{ }\KeywordTok{svydesign}\NormalTok{(}\DataTypeTok{ids =}\OperatorTok{~}\NormalTok{upa, }\DataTypeTok{strata=}\OperatorTok{~}\NormalTok{estrato, }
  \DataTypeTok{weights=}\OperatorTok{~}\NormalTok{v1027, }\DataTypeTok{data =}\NormalTok{ pnadc032016.dat, }\DataTypeTok{nest=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df_pos <-}\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{posest=}\KeywordTok{unique}\NormalTok{(pnadc032016.dat}\OperatorTok{$}\NormalTok{posest), }
  \DataTypeTok{Freq=}\KeywordTok{unique}\NormalTok{(pnadc032016.dat}\OperatorTok{$}\NormalTok{v1029))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pnadc032016.calib <-}\KeywordTok{postStratify}\NormalTok{(pnadc032016.plan, }\OperatorTok{~}\NormalTok{posest, df_pos)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{taxa_des <-}\StringTok{ }\KeywordTok{svyratio}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{vd4002}\OperatorTok{==}\StringTok{"2"}\NormalTok{ ,}
  \OperatorTok{~}\StringTok{ }\NormalTok{vd4001 }\OperatorTok{==}\StringTok{ "1"}\NormalTok{ , pnadc032016.calib , }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
...
dessa amostra no data frame \texttt{pes\_sel.dat}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pes_sel.dat <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"C:/adac/PNS/2013 long questionnaire survey.rds"}\NormalTok{)}
\KeywordTok{dim}\NormalTok{(pes_sel.dat)}
\end{Highlighting}
\end{Shaded}
...
\EndKnitrBlock{remark} O data frame \texttt{pes\_sel.dat} contém as
...
\StringTok{    }\KeywordTok{svydesign}\NormalTok{(}
        ...
        \DataTypeTok{data =}\NormalTok{ pes_sel.dat ,}
...
Os pesos do objeto de desenho \texttt{pes\_sel.plan} devem ser
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post_pop <-}\StringTok{ }\KeywordTok{unique}\NormalTok{( pes_sel.dat[ }\KeywordTok{c}\NormalTok{( }\StringTok{'v00293.y'}\NormalTok{ , }\StringTok{'v00292.y'}\NormalTok{ ) ] )}
...
\texttt{pes\_sel.plan} as informações contidas no data frame
\texttt{post\_pop}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pes_sel.calib <-}\StringTok{ }\KeywordTok{postStratify}\NormalTok{( pes_sel.plan , }\OperatorTok{~}\NormalTok{v00293.y , post_pop )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{saveRDS}\NormalTok{(pes_sel.calib, }\DataTypeTok{file =} \StringTok{"C:/adac/PNS/pns_des_sel.rds"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pes_sel.calib <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"C:/adac/PNS/pns_des_sel.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\texttt{pes\_sel.calib} já se encontra disponível no arquivo 1
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{diag_dep <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{ (pes_sel.dat}\OperatorTok{$}\NormalTok{q092}\OperatorTok{==}\StringTok{"1"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Como mencionado, o objeto de desenho pós-estratificado
\texttt{pes\_sel.calib} pode ser lido do arquivo
\texttt{2013\ all\ questionnaire\ survey\ design.rds}. Vamos atualizar o
objeto de desenho \texttt{pes\_sel.calib} para incluir a variável
\texttt{diad\_dep} na componente \texttt{variables}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pes_sel.calib <-}\StringTok{ }\KeywordTok{update}\NormalTok{ (pes_sel.calib, }\DataTypeTok{diag_dep =}\NormalTok{ diag_dep )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{diagdepbr <-}\StringTok{ }\KeywordTok{svymean}\NormalTok{(}\OperatorTok{~}\NormalTok{diag_dep, pes_sel.calib)}
\CommentTok{# estimativa em % e erro padrão}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pes_all.calib <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\StringTok{"C:/adac/PNS/2013 all questionnaire survey design.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\texttt{ppv.se.plan} que incorpora as características do plano amostral
...
\texttt{ppv.se.plan} anteriormente definido. Vamos usar a função
...
estão contidos no objeto \texttt{ppv.se.plan}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{VAAS1<-}\StringTok{ }\KeywordTok{Vwaas}\NormalTok{(ppv.se.plan}\OperatorTok{$}\NormalTok{variables[,}\StringTok{"analf1"}\NormalTok{],}\KeywordTok{weights}\NormalTok{(ppv.se.plan))}
\NormalTok{VAAS2<-}\StringTok{ }\KeywordTok{Vwaas}\NormalTok{(ppv.se.plan}\OperatorTok{$}\NormalTok{variables[,}\StringTok{"analf2"}\NormalTok{],}\KeywordTok{weights}\NormalTok{(ppv.se.plan))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{attr}\NormalTok{(}\KeywordTok{svytotal}\NormalTok{(}\OperatorTok{~}\NormalTok{analf1, ppv.se.plan),}\StringTok{"var"}\NormalTok{)}\OperatorTok{/}\NormalTok{VAAS1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{attr}\NormalTok{(}\KeywordTok{svytotal}\NormalTok{(}\OperatorTok{~}\NormalTok{analf2, ppv.se.plan),}\StringTok{"var"}\NormalTok{)}\OperatorTok{/}\NormalTok{VAAS2}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{analf1.se<-}\KeywordTok{with}\NormalTok{(ppv1.dat,((v04a01}\OperatorTok{==}\DecValTok{2}\OperatorTok{|}\NormalTok{v04a02}\OperatorTok{==}\DecValTok{2}\NormalTok{) }\OperatorTok{&}\StringTok{ }\NormalTok{(v02a08}\OperatorTok{>=}\DecValTok{7}\OperatorTok{&}\NormalTok{v02a08}\OperatorTok{<=}\DecValTok{14}\NormalTok{))}\OperatorTok{&}\NormalTok{(regiao}\OperatorTok{==}\DecValTok{2}\NormalTok{))}
\NormalTok{analf2.se<-}\KeywordTok{with}\NormalTok{(ppv1.dat,((v04a01}\OperatorTok{==}\DecValTok{2}\OperatorTok{|}\NormalTok{v04a02}\OperatorTok{==}\DecValTok{2}\NormalTok{) }\OperatorTok{&}\StringTok{ }\NormalTok{(v02a08}\OperatorTok{>}\DecValTok{14}\NormalTok{))}\OperatorTok{&}\NormalTok{(regiao}\OperatorTok{==}\DecValTok{2}\NormalTok{))}
\NormalTok{ppv.plan <-}\StringTok{ }\KeywordTok{update}\NormalTok{ (ppv.plan,}\DataTypeTok{analf1.se=}\NormalTok{analf1.se,}\DataTypeTok{analf2.se=}\NormalTok{analf2.se  )}
\KeywordTok{svytotal}\NormalTok{(analf1.se,ppv.plan,}\DataTypeTok{deff=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svytotal}\NormalTok{(analf2.se,ppv.plan,}\DataTypeTok{deff=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svytotal}\NormalTok{(}\OperatorTok{~}\KeywordTok{I}\NormalTok{(}\KeywordTok{ifelse}\NormalTok{(regiao}\OperatorTok{==}\DecValTok{2}\NormalTok{,analf1,}\DecValTok{0}\NormalTok{)),ppv.plan,}\DataTypeTok{deff=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svytotal}\NormalTok{(}\OperatorTok{~}\KeywordTok{I}\NormalTok{(}\KeywordTok{ifelse}\NormalTok{(regiao}\OperatorTok{==}\DecValTok{2}\NormalTok{,analf2,}\DecValTok{0}\NormalTok{)),ppv.plan,}\DataTypeTok{deff=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\texttt{analf1.se} com o objeto de desenho \texttt{ppv.plan} ou a
variável \texttt{analf1} com o objeto \texttt{ppv.se.plan}. Porém na
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ppv.se<-ppv.se.des.jkn}\OperatorTok{$}\NormalTok{variables}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fact.peso.comp<-ppv.se.des.jkn}\OperatorTok{$}\NormalTok{repweights[[}\DecValTok{1}\NormalTok{]]}
\NormalTok{ind.cong<-ppv.se.des.jkn}\OperatorTok{$}\NormalTok{repweights[[}\DecValTok{2}\NormalTok{]]}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(mat.rep.pesos))\{}
\NormalTok{rep.est.raz[i]<-}\KeywordTok{sum}\NormalTok{(mat.rep.pesos[,i]}\OperatorTok{*}\NormalTok{ppv.se}\OperatorTok{$}\NormalTok{analf.faixa)}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(mat.rep.pesos[,i]}\OperatorTok{*}\NormalTok{ppv.se}\OperatorTok{$}\NormalTok{faixa)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mean.raz<-}\KeywordTok{mean}\NormalTok{( rep.est.raz[ppv.se.des.jkn}\OperatorTok{$}\NormalTok{rscales}\OperatorTok{>}\DecValTok{0}\NormalTok{])}
\NormalTok{var.jack.raz<-}\StringTok{ }\KeywordTok{sum}\NormalTok{((rep.est.raz}\OperatorTok{-}\NormalTok{mean.raz)}\OperatorTok{^}\DecValTok{2}\OperatorTok{*}\NormalTok{ppv.se.des.jkn}\OperatorTok{$}\NormalTok{rscales)}\OperatorTok{*}\NormalTok{ppv.se.des.jkn}\OperatorTok{$}\NormalTok{scale}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{var.raz.rep<-}\KeywordTok{withReplicates}\NormalTok{(ppv.se.des.jkn, }\ControlFlowTok{function}\NormalTok{(w,ppv.se) }\KeywordTok{sum}\NormalTok{(w}\OperatorTok{*}\NormalTok{ppv.se}\OperatorTok{$}\NormalTok{analf.faixa)}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(w}\OperatorTok{*}\NormalTok{ppv.se}\OperatorTok{$}\NormalTok{faixa))}
...
\NormalTok{Nh<-}\KeywordTok{table}\NormalTok{(popul}\OperatorTok{$}\NormalTok{estrat)}
...
\NormalTok{popul}\OperatorTok{$}\NormalTok{sal <-}\StringTok{ }\NormalTok{popul}\OperatorTok{$}\NormalTok{sal}\OperatorTok{/}\DecValTok{1000}
\NormalTok{popul}\OperatorTok{$}\NormalTok{rec <-}\StringTok{ }\NormalTok{popul}\OperatorTok{$}\NormalTok{rec}\OperatorTok{/}\DecValTok{1000000}
...
\NormalTok{sal_med_y<-}\KeywordTok{mean}\NormalTok{(dados}\OperatorTok{$}\NormalTok{sal)}
\NormalTok{rec_med_y<-}\KeywordTok{mean}\NormalTok{(dados}\OperatorTok{$}\NormalTok{rec)}
\CommentTok{# estimador v0}
\NormalTok{sal_var_aas<-(}\DecValTok{1}\OperatorTok{-}\NormalTok{f)}\OperatorTok{*}\KeywordTok{var}\NormalTok{(dados}\OperatorTok{$}\NormalTok{sal)}\OperatorTok{/}\NormalTok{n}
\NormalTok{rec_var_aas<-(}\DecValTok{1}\OperatorTok{-}\NormalTok{f)}\OperatorTok{*}\KeywordTok{var}\NormalTok{(dados}\OperatorTok{$}\NormalTok{rec)}\OperatorTok{/}\NormalTok{n}
...
\DataTypeTok{Quantidade_de_interesse =} \KeywordTok{c}\NormalTok{(}\StringTok{"Média_populacional_Ybar"}\NormalTok{, }\StringTok{"Média_de_ybar_sobre_ 500_ amostras"}\NormalTok{,}
  \StringTok{"Média_de_ybarw_sobre_500_amostras"}\NormalTok{),}
\NormalTok{Salá}\DataTypeTok{rios =} \KeywordTok{c}\NormalTok{(}\KeywordTok{mean}\NormalTok{(popul}\OperatorTok{$}\NormalTok{sal), sal_res_mean[}\DecValTok{1}\NormalTok{],sal_res_mean[}\DecValTok{2}\NormalTok{] ),}
\DataTypeTok{Receitas =} \KeywordTok{c}\NormalTok{(}\KeywordTok{mean}\NormalTok{(popul}\OperatorTok{$}\NormalTok{rec),rec_res_mean[}\DecValTok{1}\NormalTok{],rec_res_mean[}\DecValTok{2}\NormalTok{] )  }
\NormalTok{)}
...
Média\_de\_ybar\_sobre\_ 500\_ amostras & 163.28824 & 4.281775\\
Média\_de\_ybarw\_sobre\_500\_amostras & 77.90478 & 2.121751\\
\bottomrule
\end{tabular}
...
Média\_de\_ Vhat\_AES(yvarw) & 232.9632 & 0.4252684\\
Valor\_esperado\_de\_v0\_usando\_população & NA & NA\\
Média\_de\_v0\_usando\_500\_amostras & 1652.9866 & 1.2896497\\
\bottomrule
\end{tabular}
