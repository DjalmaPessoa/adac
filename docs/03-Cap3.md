...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-1"><strong>(\#ex:unnamed-chunk-1)</strong></span>Amostragem Aleatória Simples Sem Reposição (AAS)</div>\EndKnitrBlock{example}
...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="ex:unnamed-chunk-2"><strong>(\#ex:unnamed-chunk-2)</strong></span>Matriz de covariância para um vetor de razões</div>\EndKnitrBlock{example}
