...
tab73 <- data.frame(Idade= levels(ppv1$IDATAB), Prop_Contagem= c(0.2842, 0.2747, 0.2263, 0.1261, 0.0860), Frequência= Freq, Prop_est_PPV= ppv.id$mean,EPA = ppv.id$deff) 
