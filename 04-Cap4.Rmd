...
knitr::kable(df.res, booktabs=TRUE, align = "ccccc",
...
eigen(DELTA)$values
```
Os autovalores de DELTA  `r eigen(DELTA)$values[1]` e 
`r eigen(DELTA)$values[2]` são os efeitos generalizados do plano amostral.
