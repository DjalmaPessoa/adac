...
Os exemplos apresentados no Capítulo \@ref(efeitos-do-plano-amostral) demonstram claramente a inadequa
...
s}w_{i}\mathbf{u}_{i}\left( \mathbf{\theta }\right)$ (veja Capítulo \@ref(estimacao-baseada-no-plano-amostral))
...
condições de regularidade enunciadas em [@apêndice] e
