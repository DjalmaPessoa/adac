...
\ref{Analisec} do Capítulo \@ref(ajmodpar). Se calcularmos as estatísticas 
...
sem fixar marginais. Consideremos a Tabela \@ref(tab:??) com as propor
...
de dimensão $\left( L-1\right) \left( C-1\right) \times $
...
Considerando os dados do Exemplo \ref{pnad90} do Capítulo \@ref(modreg), vamos
...
```{r, frqamost, results='asis',echo=FALSE}
