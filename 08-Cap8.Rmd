...
marg_ret <- transform (marg_re, se.re1= 10000*se.re1, se.re2= 10000*se.re2,se.re3= 10000*se.re3)
knitr::kable(marg_ret ,booktabs=TRUE, digits=3,
...
row.names(frame_sx_re)<-c("sx=1,re=1","sx=2,re=1",
  "sx=1,re=2","sx=2,re=2", "sx=1,re=3", "sx=2,re=3")
...
```{r, echo=FALSE}
library(xtable)
print(xtable(svyby(~re,~sx,pnad.des, svymean,keep.var=TRUE), caption="Proporções por sexo"), include.rownames=FALSE)
```
